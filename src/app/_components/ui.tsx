  ...
  return (
    <header className="flex items-start justify-between gap-4">
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-semibold leading-[var(--lh-heading)] tracking-tight">{title}</h1>
...
export function ButtonLink({
  ...
  return (
    <Link
      href={href}
      className="rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium hover:bg-neutral-50"
    >
      {children}
    </Link>
  );
